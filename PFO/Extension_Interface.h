...
// finding and runnine user scripts from name
inline int Script_Find_Id(const char* name) { return g_pYYRunnerInterface->Script_Find_Id(name); }
...
// finding builtin functions
inline bool  Code_Function_Find(const char* name, int* ind) { return g_pYYRunnerInterface->Code_Function_Find(name, ind); }
