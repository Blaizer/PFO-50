...
online multiplayer support directly into UFO 50 v1.8.35.
...
Uninstallation
--------------
You can uninstall PFO 50 completely by right clicking UFO 50 in your Steam
Library, selecting "Properties...", navigating to the "Installed Files" tab
and then clicking "Verify integrity of game files".

Credits
-------
PFO 50 is mostly a one-man project, but it was made possible thanks to the
help from these wonderful people:

* Sailor: testing and moral support
* Stew: community tournament host
* p-sam: ufo50-patcher
* Phil: GMLoader for UFO 50
* Mossmouth: making such a great game
* ... and many others from the UFO 50 Community Discord
